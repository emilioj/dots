...
-- Obvious fork from https://github.com/hoelzro/obvious
...
globalkeys = gears.table.join(
    ...
    -- Lock
    awful.key({ modkey }, "F3",
              function () awful.util.spawn('i3lock -c000000') end),
...
--       awful.util.spawn("amixer set Master 5%+", false) end),
       obvious.volume_alsa.raise(0,"Master") end),
    awful.key({ }, "XF86AudioLowerVolume", function ()
--       awful.util.spawn("amixer set Master 5%-", false) end),
       obvious.volume_alsa.lower(0,"Master") end),
...
--       awful.util.spawn("amixer sset Master toggle", false) end),
   ...
   awful.key({ modkey }, "Print", function ()
        awful.util.spawn("import -window root -quality 98 /tmp/screenshot-".. os.time() ..".png") end),
